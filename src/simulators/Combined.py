...
import time
import logging
from Data_Simulator import RealSensorSimulator  # ← CHANGÉ ICI
...
class RealCombinedSimulator:
    ...
    def start_all_simulations(self):
        ...
        logger.info("=" * 60)
        logger.info("📊 Sensor Data: Every 10 seconds → Kafka + InfluxDB")
        logger.info("🭭 Production Plans: Every 30 seconds → Kafka")
        logger.info("ℹ️  Press Ctrl+C to stop all simulations")
        logger.info("=" * 60)
